      ...
      <div>
        ...
        <nav className="navbar navbar-expand-sm navbar-light">
          <div className="container">
            ...
            >
              <a href="http://s3-bnb.s3-website-us-east-1.amazonaws.com/s3-bnb-serverless/">Digital Identity ERC-725</a>
            </Link>
        ...
        <div className="container">
          ...
          <div className="footer">
            ...
            <div className="right">
              <a href="https://github.com/o2oprotocol/digital-identity">
